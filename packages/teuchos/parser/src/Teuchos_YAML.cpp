...
Language make_language() {
  ...
  prods[PROD_ONE_TOP]("toplevel") >> "toplevel_item";
  prods[PROD_NEXT_TOP]("toplevel") >> "toplevel", "toplevel_item";
  prods[PROD_TOP_BLOCK]("toplevel_item") >> "block_map_item";
  prods[PROD_TOP_END]("toplevel_item") >> ".", ".", ".", "EQDENT";
  ...
  prods[PROD_BMAP_ITEMS]("block_map_items") >> "block_map_items", "block_map_item";
  prods[PROD_BSEQ_ITEM]("block_sequence_items") >> "block_sequence_item";
  prods[PROD_BSEQ_ITEMS]("block_sequence_items") >> "block_sequence_items", "block_sequence_item";
  prods[PROD_BSEQ_SCALAR]("block_sequence_item") >> "BLOCK_SEQ", "scalar", "EQDENT";
  prods[PROD_BMAP_ITEM]("block_map_item") >> "scalar", ":", "S?", "block_map_value";
  prods[PROD_BMAP_SCALAR]("block_map_value") >> "scalar", "EQDENT";
