...
Language make_language() {
  ...
  prods[PROD_BSEQ]("BLOCK_SEQ") >> "-", "S";
  prods[PROD_COMMENT]("COMMENT") >> "#", "CHAR*";
  prods[PROD_DOC_START]("DOC_START") >> "-", "-", "-";
  prods[PROD_DOC_END]("DOC_END") >> ".", ".", ".";
  prods[PROD_DIRECTIVE]("DIRECTIVE") >> "%", "CHAR*";
  prods[PROD_RAW]("RAW_SCALAR") >> "RAW_FIRST", "RAW_REST";
  ...
  prods[PROD_DQUOTED]("DOUBLE_QUOTED") >> "\"", "DQUOTED_CHAR*", "\"";
  ...
  prods[PROD_SQUOTED]("SINGLE_QUOTED") >> "'", "SQUOTED_CHAR*", "SQUOTED_CONTD*", "'";
